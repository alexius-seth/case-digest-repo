  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between pb-4 border-b border-gray-200 print:hidden">
        <Link href="/dashboard" className="text-xs font-semibold text-gray-600 hover:text-foreground">
          ← Back to Dashboard
        </Link>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            ...
            className="px-3 py-1.5 bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 text-xs font-semibold rounded transition-colors"
          >
            Edit Digest
          </Link>
          <button
            ...
            disabled={deleting}
            className="px-3 py-1.5 bg-red-50 text-red-600 border border-red-200 hover:bg-red-100 text-xs font-semibold rounded transition-colors disabled:opacity-50"
          >
      ...
      {/* Case Header */}
      <div className="bg-white p-6 border border-gray-200 rounded-lg space-y-3 print:border-none print:p-0">
        ...
        <p className="text-sm font-mono text-gray-500">{digest.gr_number}</p>
      </div>

      {/* Doctrine Banner */}
      {digest.doctrine && (
        <div className="p-5 bg-amber-50/60 border-l-4 border-accent rounded-r-lg print:border-l-2">
      ...
      <div className="bg-white p-6 border border-gray-200 rounded-lg space-y-6 print:border-none print:p-0">
        <div>
          <h2 className="text-xs font-bold text-foreground uppercase tracking-wider pb-2 border-b border-gray-100 mb-3">
            Facts of the Case
          </h2>
      ...
      {/* Philippine Legal Full-Text External Links (Hidden during print) */}
      <div className="bg-gray-50 p-6 border border-gray-200 rounded-lg space-y-3 print:hidden">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
          {legalSources.map((source) => (
            <a
              ...
              className="p-3 bg-white border border-gray-200 hover:border-accent rounded shadow-sm text-left transition-all hover:shadow group"
            >
