...
export default function CaseDetailPage({
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      {/* Case Header */}
      <div className="bg-white p-6 border border-gray-200 rounded-lg space-y-3">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <span className="text-xs px-3 py-1 rounded-full bg-accent-light text-accent-hover font-semibold">
      ...
      {/* Key Legal Doctrine (Highlighted Box) */}
      <div className="p-5 bg-pink-50/50 border-l-4 border-accent rounded-r-lg space-y-1">
      ...
      <div className="space-y-6 bg-white p-6 border border-gray-200 rounded-lg">
        {/* Facts */}
